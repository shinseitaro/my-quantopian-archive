...
def process_data_and_order(context, data):
    ...
    if len(context.prices)<context.nobs:
        ...
        print(comb_price_past_window[-5:])
        ...
        log.info("h={h}, comb_price={comb_price}, meanPrice={meanPrice}, stdPrice={stdPrice}".format(h = h, comb_price = comb_price,meanPrice=meanPrice,stdPrice=stdPrice))
