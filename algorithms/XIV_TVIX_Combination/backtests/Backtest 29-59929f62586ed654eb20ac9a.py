...
def initialize(context):
    ...
    context.xiv =  sid(37736)# xiv
    context.tvix = sid(37737)
...
def rebalance(context, data):
    ...
    if len(ctvix_p) > 2 and \
        ...
        order_target_percent(context.xiv, d*UTILIZATION*0.5)
        order_target_percent(context.tvix, d*UTILIZATION*TVIX_MULTIPLIER*0.25)
    else:
