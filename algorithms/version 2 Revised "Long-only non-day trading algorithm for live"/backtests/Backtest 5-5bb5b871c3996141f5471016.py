...
def before_trading_start(context, data):
    ...
    if positions:
        log.info(context.output.loc[context.stocks_worst].sort_values(by="average_dollor_vol", )["average_dollor_vol"].head())
