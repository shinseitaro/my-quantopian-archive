...
def initialize(context):
    ...
    context.sym1 = continuous_future(sym1, roll='calendar', offset=2)
    context.sym2 = continuous_future(sym2, roll='calendar', offset=2)
...
#                         frequency = '1d')
#     ratio = hist[context.sym1] / hist[context.sym2]
#     upper, middle, lower = ta.BBANDS(ratio,timeperiod=10) 
#     return upper < ratio 
...
def my_rebalance(context, data):
    ...
    # ショートポジション注文        
    elif context.ratio > 1.03: 
        target_weight[contract_sym1] = -0.8
        target_weight[contract_sym2] = 0.8
