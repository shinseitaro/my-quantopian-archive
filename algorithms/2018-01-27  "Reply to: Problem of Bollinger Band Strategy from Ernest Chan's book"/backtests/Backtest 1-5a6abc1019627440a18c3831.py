...
def before_trading_start(context, data):
    # for posi in context.portfolio.positions:
    #     log.info(posi.sid , posi.amount, posi. cost_basis, posi.amount* posi. cost_basis, )
    
    for pos in context.portfolio.positions:  
        log.info(context.portfolio.positions[pos].sid.symbol,
                 context.portfolio.positions[pos].amount,
                 context.portfolio.positions[pos].cost_basis,
                 context.portfolio.positions[pos].amount * context.portfolio.positions[pos].cost_basis,)
